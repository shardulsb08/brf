...
DEFAULT_PATHS=(
	"/mnt/work_4gb/Dev/mpiric_kernel_dev_env/shared/mpiric/027_netdev_0x1a_proposal/work/brf_protocol_fuzz_setup/syz_manager/workdir_v01/brf_verifier_stats/stats.*.log"
